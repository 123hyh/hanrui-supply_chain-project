          ...
          <div class="ms-login-form-box">
            ...
            >
              <el-form-item prop="userCode">
                <el-input id="username" v-model="ruleForm.userCode" autofocus placeholder="请输入登录账号"></el-input>
              </el-form-item>
              ...
              <el-form-item prop="vCode" class="vCode-form">
                <el-input
                  id="vCode"
                  type="vCode"
...
export default {
  ...
  data: function() {
    ...
    return {
      ...
      identifyCode: "",
      identifyCodes:
        "1234567890qwertyuipasdfghjkzxcvbnmQWERTYUIPASDFGHJKLZXCVBNM",
  ...
  methods: {
    ...
    makeCode(o, l) {
      ...
      process.env.NODE_ENV !== "production" &&
        (this.ruleForm.vCode = this.identifyCode);
    },
    ...
    jumpPage() {
      ...
      this.$router.push({
        path:
          this.$route.query.redirect === "#/login?redirect=%2FM00" ||

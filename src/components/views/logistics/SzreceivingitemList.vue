  ...
  <div class="table">
    ...
    <div class="container pd-10">
        ...
        <div class="handle-box">
            <el-form :inline="true">
                <el-form-item label="编码">
                    <el-input v-model="querySzreceivingitem.itemCode" style="width: 150px"></el-input>
                </el-form-item>
                <el-form-item label="名称">
                    <el-input v-model="querySzreceivingitem.name" style="width: 150px"></el-input>
                </el-form-item>
                <el-form-item label="制单人">
                    <el-input v-model="querySzreceivingitem.creator" style="width: 150px"></el-input>
                </el-form-item>
                <el-form-item label="制单时间">
                    <el-date-picker
                            value-format="yyyy-MM-dd HH:mm:ss"
                            v-model="querySzreceivingitem.createTimeFrom"
                            type="date"
                            style="width: 150px"
                    ></el-date-picker>~
                    <el-date-picker
                            value-format="yyyy-MM-dd HH:mm:ss"
                            v-model="querySzreceivingitem.createTimeTo"
                            type="date"
                            style="width: 150px"
                    ></el-date-picker>
                </el-form-item>
      ...
      <el-table :data="tableData" border :highlight-current-row="true">
				...
				<el-table-column prop="warehousingCount" label="仓库已入库数量"></el-table-column>
      ...
      <div class="pagination">
        <el-pagination
          ref="pager"
          background
          :page-size="querySzreceivingitem.pageSize"
          :current-page="querySzreceivingitem.pageIndex"
          layout="sizes, total, prev, pager, next"
          :total="querySzreceivingitem.total"
          @current-change="goPage"
        ></el-pagination>
      </div>
    </div>

    <szreceivingitem-form :show="popForm" @closeform="closeForm"></szreceivingitem-form>
...
import SzreceivingitemForm from "./SzreceivingitemForm";
...
export default {
  ...
  methods: {
    queryPage() {
      appHelper.query("/szreceivingitem/search", this.querySzreceivingitem).then(result => {
        this.tableData = result.data.list;
        this.querySzreceivingitem.total = result.data.count;
      });
    },

    queryData(){
      this.querySzreceivingitem.pageIndex = 1;
    ...
    goPage: function(index) {
      ...
      this.$axios
        .post(appHelper.apiPath("/szreceivingitem/search"), {
          pageIndex: index,

<template>
  <el-dialog :visible.sync="popup">
    <!-- 标题 -->
    <div slot="title">{{isUpdate ? '修改' : '新增'}}收货通知单子表-基本信息</div>
    ...
    <el-form ref="form" :model="formEntity" label-position="right" :inline="true" :rules="formRules">
			<el-row>
				<el-col :span="12">
					<el-form-item :label-width="labelWidth" label="子表编码-基本信息" prop="itemCode">
						<el-input v-model="formEntity.itemCode" :class="inputClass" ></el-input>
					</el-form-item>
				</el-col>
				<el-col :span="12">
					<el-form-item :label-width="labelWidth" label="收货通知单编码" prop="receiptOrderCode">
						<el-input v-model="formEntity.receiptOrderCode" :class="inputClass" ></el-input>
					</el-form-item>
				</el-col>
			</el-row>
			<el-row>
			...
			<el-row>
				<el-col :span="12">
					<el-form-item :label-width="labelWidth" label="规则型号" prop="ruleType">
						<el-input v-model="formEntity.ruleType" :class="inputClass" ></el-input>
					</el-form-item>
				</el-col>
				<el-col :span="12">
			...
			<el-row>
				<el-col :span="12">
					<el-form-item :label-width="labelWidth" label="累计入库数量" prop="warehousingCountAll">
						<el-input v-model="formEntity.warehousingCountAll" :class="inputClass" ></el-input>
					</el-form-item>
				</el-col>
				<el-col :span="12">
					<el-form-item :label-width="labelWidth" label="采购订单号" prop="purchaseOrderNo">
			...
			<el-row>
				<el-col :span="12">
					<el-form-item :label-width="labelWidth" label="采购订单行号" prop="purchaseOrderRowNo">
						<el-input v-model="formEntity.purchaseOrderRowNo" :class="inputClass" ></el-input>
					</el-form-item>
				</el-col>
				<el-col :span="12">
			...
			<el-row>
				...
				<el-col :span="12">
					<el-form-item :label-width="labelWidth" label="仓储已入库数量" prop="hasIncomingNo">
						<el-input v-model="formEntity.hasIncomingNo" :class="inputClass" ></el-input>
					</el-form-item>
				</el-col>
			</el-row>
			<el-row>
			...
			<el-row>
				<el-col :span="12">
					<el-form-item :label-width="labelWidth" label="制单人" prop="originator">
						<el-input v-model="formEntity.originator" :class="inputClass" ></el-input>
					</el-form-item>
				</el-col>
			</el-row>
...
<script>
import ReceiptBase from "../../../domain/entities/logistics/ReceiptBase";
...
export default {
  ...
  data() {
    return {
      formEntity: this.isUpdate ? this.curEntity : new ReceiptBase(),
    ...
    saveForm() {
      ...
      this.$refs.form.validate().then(() => {
        ...
        if (!this.isUpdate) {
          // 新增
          appHelper
            .submitCreate("/receiptbase/", self.formEntity)
            .then(function() {
              // 提交成功后...
              
              alert("保存成功！");
            });
          this.formEntity = new ReceiptBase();
          this.loadReceiptBaseCode();
          this.popup = false;
        } else {
          // 修改
          appHelper

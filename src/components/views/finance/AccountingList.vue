		...
		<div class="container pd-10">
			...
			<!-- 查询栏 -->
				<el-form :inline="true" :model="queryReceipt" :rules="rules" ref="queryReceipt">
					...
					<el-form-item label="结算单号" prop="classifyName">
						<el-input v-model="queryReceipt.name" style="width: 150px"></el-input>
					</el-form-item>
					<el-form-item label="委托单号" prop="state">
						<el-input v-model="queryReceipt.name" style="width: 150px"></el-input>
					</el-form-item>
			...
			<el-table :data="tableData" border highlight-current-row @row-click="clickRow" ref="moviesTable">
				<el-table-column prop="billNo" label="委托单号" width="132"></el-table-column>
				<el-table-column prop="company" label="调整应计金额" width="132"></el-table-column>
				<el-table-column prop="actualReceiptCompany" label="调整内部成本价" width="132"></el-table-column>
				<el-table-column prop="receivedDate" label="是否开票" width="132"></el-table-column>
				<el-table-column prop="receiptsAndPaymentsType" label="申请调整原因" width="132"></el-table-column>
			</el-table>
	...
	export default {
		...
		methods: {
			...
			goCreate() {
				...
				this.$router.push('AccountingForm')
			},
			// 新增

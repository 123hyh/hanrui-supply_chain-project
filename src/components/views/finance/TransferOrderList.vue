    ...
    <div class="container pd-10">
      ...
      <div class="pagination">
        <el-pagination
          ...
          :page-size.sync="queryReceipt.pageSize"
          :current-page.sync="queryReceipt.pageIndex"
          layout="sizes, total, prev, pager, next"
          :total="queryReceipt.total"
...
export default {
  ...
  methods: {
    // 查询数据
    async queryPage (index, pageSize) {
      this.queryReceipt.pageIndex = 1; //页签调到第一页
      let { data: { list, count } } = await appHelper.getSingleTurnParagraph(this.queryReceipt);
      this.tableData = list, this.queryReceipt.total = count;

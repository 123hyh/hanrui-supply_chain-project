      ...
      return {
        ...
        async update () {
          if (JSON.stringify(this.curRowData) == '{}') {
            ...
            const { data } = await api.searchOneclientevaluationData(this.curRowData.itemCode);
        ...
        delete () {
          if (JSON.stringify(this.curRowData) == '{}') {
            ...
            this.utools.deleteMessage.bind(this)(async () => {
              try {
                const { data, status } = await api.deleteclientevaluationData(this.curRowData.itemCode)

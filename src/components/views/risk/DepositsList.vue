...
export default {
  ...
  methods: {
    ...
    async handlerFormConfigClickSearch (params) {
      ...
      dataType === "String" &&
        ...
        ((this.tableDialog.ruleForm = {}),
          ...
          (this.tableDialog = {
            ...this.tableDialog,
            ...(isRep
              ? this.setDialogTitleAndQuery[this.tableDialogTarget][type]
      ...
      try {
        ...
        const WHITE_LIST = ['inInsureUnitName', 'outInsureUnitName', 'repealPersonName']
        const {
          data: { list, count }
        } = await request({
  ...
  computed: {
    ...
    queryBarRequest () {
      return {
        delete: _ => api.deleteDepositsData(this.tableClickRow.depositsNo),
    ...
    tableDialogRequest () {
      return {
        ...
        inInsureUnitName: (data = {}) => api.getCreditCompanyNameData(data),

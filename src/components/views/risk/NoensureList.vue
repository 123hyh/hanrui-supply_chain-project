...
export default {
  ...
  methods: {
    ...
    sumCreditMoney (creditAmount, exchangeRate) {
      ...
      this.formDialog.ruleForm.creditRmbAmount = creditAmount * exchangeRate;
    },
        ...
        case "add":
          {
            try {
              ...
              this.formDialog.ruleForm = { ...this.formDialog.ruleForm, noCreditNo: data };
    ...
    async handlerFormConfigClickSearch (params) {
      ...
      dataType === "String" &&
        ...
        ((this.tableDialogTarget = params),
          (this.tableDialog = {
            ...this.tableDialog,
            tableConfig: this.tableDialogConfig[this.tableDialogTarget](),
            isshow: true,
  ...
  computed: {
    ...
    queryBarFormConfig () {
      return [
        { label: "委托方编码", moduleBind: "customerCode", isInput: true },
    ...
    queryBarRequest () {
      return {
        delete: _ => api.deleteNoensureData(this.tableClickRow.noCreditNo),
    ...
    tableDialogRequest () {
      return {
        ...
        creditCompanyName: (data = {}) => api.getCreditCompanyNameData(data),

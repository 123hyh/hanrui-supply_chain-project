...
import tableconfig from '@/domain/tableconfig/basicdata/GoodsAttribute.js'
import ruleForm from '@/domain/entities/basicdata/GoodsAttribute'
import formConfig from '@/domain/formconfig/basicdata/GoodsAttribute.js'

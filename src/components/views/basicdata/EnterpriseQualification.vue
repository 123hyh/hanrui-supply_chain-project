...
import tableconfig from '@/domain/tableconfig/basicdata/EnterpriseQualification.js'
import ruleForm from '@/domain/entities/basicdata/EnterpriseQualification'
import formConfig from '@/domain/formconfig/basicdata/EnterpriseQualification.js'

...
import tableconfig from '@/domain/tableconfig/basicdata/Reasons.js'
import ruleForm from '@/domain/entities/basicdata/Reasons'
import formConfig from '@/domain/formconfig/basicdata/Reasons.js'

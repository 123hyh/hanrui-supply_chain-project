...
export default {
  ...
  computed: {
    ...
    // 表格按钮的控制
    showBtn(){
      return this.subActiveName === 'bank' ? this.subActiveName :( (+this.form.data.status) <= 1 ? this.subActiveName:'')
    },
    // initTabList: _ => [
    //   {
    //     label: "基础资料",
    ...
    initTableConfig: _ => ({
      ...
      bank: _ =>
        require("@/domain/tableconfig/basicdata/CustomerBankTrial.js").default,

    ...
    clickTypeAsync () {
      return {
        ...
        'add': () => (
          ...
          this.loadCodeNo(),
          this.formDialog.ruleForm = { ...new ruleForm(), entrustOrderTypeCode: this.formDialog.ruleForm.entrustOrderTypeCode }
        ),
        ...
        'delete': () => {
          utools.titleCallBack.call(
            ...
            utools.removeReceiptsTips.bind(
              this,
              async () => {
                await api.deleteentrustordertypeData(this.formDialog.clickRow.entrustOrderTypeCode);
  ...
  methods: {
          ...
          utools.saveReceiptsTips.call(
            ...
            async () => {
              const {
                data,
                status
              } = await api.changeEntrustordertypeData({ data: this.formDialog.ruleForm, method: this.formDialog.btnKey === 'add' ? 'POST' : 'PUT' });
    ...
    async loadCodeNo () { //加载编号
      ...
      try {
        ...
        this.$set(this.formDialog.ruleForm, 'entrustOrderTypeCode', data)
      } catch (e) {

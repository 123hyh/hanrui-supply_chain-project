...
import tableconfig from '@/domain/tableconfig/basicdata/OriginArea.js'
import ruleForm from '@/domain/entities/basicdata/OriginArea'
import formConfig from '@/domain/formconfig/basicdata/OriginArea.js'

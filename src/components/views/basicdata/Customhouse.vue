...
import tableconfig from '@/domain/tableconfig/basicdata/Customhouse.js'
import ruleForm from '@/domain/entities/basicdata/Customhouse'
import formConfig from '@/domain/formconfig/basicdata/Customhouse.js'
